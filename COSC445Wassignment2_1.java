...
class COSC445Wassignment2_1 {
  public static void main(String[] args) {
    try {
      ...
      writeFileSet();
      long n;
      findMiss( n = setValue(2, 12, "n"), setValue(10, setUpperBound(n), "k"));
       }
    catch (IOException e) {
  ...
  static void findMiss(long n, long k) {
    try {
  ...
  public static long setUpperBound(long power) {
    long maxLong = Long.MAX_VALUE;
    long bound = (long)(Math.floor(Math.pow(maxLong, (1.0 / power))) / 2.0);
    return bound - 1;
  }
  public static void writeFileSet() throws IOException {
